...
def build_validated_direct_answer(
    ...
    """Build the headline answer only from validated claims.

    Requirements take precedence because they answer normative
    compliance questions most directly. If no requirement survives
    validation but explicit role/responsibility evidence does, return
    the validated role statement itself instead of a generic message.
    """
